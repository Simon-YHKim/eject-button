# plan-eng-review — Detailed Reference
...
5. **Task-list cross-reference:** Read `TASKS.md` if it exists. Are any deferred items blocking this plan? Can any deferred items be bundled into this PR without expanding scope? Does this plan create new work that should be captured as a task?
...
Then present options: **A)** Add to TASKS.md **B)** Skip — not valuable enough **C)** Build it now in this PR instead of deferring.
